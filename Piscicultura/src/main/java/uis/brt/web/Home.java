...
public class Home {
	...
	String group = "group", element = "element", fish = "fish", weather = "weather", cycle = "cycle";
    ...
    public String AgregarPorPost(@FormParam("group") String group, @FormParam("element") String element, @FormParam("fish") String fish,
    							 @FormParam("weather") String weather, @FormParam("cycle") String cycle,
