...
public class Consult {
	...
	public Consult(EventBus bus, ContextInformation context, List<ContextInformation> pond) {
		this.bus = bus;
	...
	//@Path("/modificar")
	@Produces(MediaType.APPLICATION_JSON)//({MediaType.TEXT_HTML, MediaType.APPLICATION_JSON}) //@Produces(MediaType.TEXT_PLAIN) // (MediaType.APPLICATION_JSON)
	public String SeleccModificar(){
		...
		for(ContextInformation und : pond){
			link = "http://localhost:8080/consultar/";
