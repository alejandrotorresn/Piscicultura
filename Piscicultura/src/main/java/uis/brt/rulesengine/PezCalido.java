...
@Rule//(name = "Pez calido", description = "Evalua la medición del termometro y si es menor a la permitida, devuelve una advertencia")
public class PezCalido implements PlatformRule {
	...
	public String getDescription() {
		return "Evalua la medición del termometro y si es menor a la permitida, devuelve una advertencia";
	}
	@Priority
