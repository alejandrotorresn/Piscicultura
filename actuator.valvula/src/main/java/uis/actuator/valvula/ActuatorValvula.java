...
public class ActuatorValvula implements Actuator{

	private String type = "valvula"; // valor fijo, debido a que estamos en la clase especifica ActuatorValvula
